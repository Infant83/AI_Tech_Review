...
레이아웃 검증을 마친 8페이지 원문 브리프는 [PDF로 내려받을 수 있다](../artifacts/oled_inverse_design_weekly_brief_2026-08-28.pdf).
...
![이번 주 7편의 논문을 OLED 근접성과 증거 층으로 배치한 정성적 지도](../artifacts/evidence_readiness_map.svg)
