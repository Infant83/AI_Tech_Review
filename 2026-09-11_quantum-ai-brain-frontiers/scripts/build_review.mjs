...
for(const lang of ['ko','en']){
 ...
 const html=`<!doctype html><html lang="${lang}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="${escape(desc)}"><meta name="author" content="AI Tech Review"><meta property="og:type" content="article"><meta property="og:description" content="${escape(desc)}"><meta property="og:url" content="${canonical}"><meta property="og:image" content="${base}quantum_vacuum_birefringence_cover_v2.webp"><meta name="twitter:card" content="summary_large_image">${alternates}<title>${escape(title)}</title><style>${css}</style></head><body><header class="topbar"><a href="https://infant83.github.io/AI_Tech_Review/"><strong>AI TECH REVIEW</strong></a><a href="#vacuum">Quantum</a><a href="#ai">AI</a><a href="#brain">Brain</a><span>2026.09.11</span></header><main><article>${body}</article></main><script>${js}</script></body></html>\n`;
