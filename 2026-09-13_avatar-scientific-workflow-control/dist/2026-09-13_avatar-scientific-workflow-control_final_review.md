...
![빠르게 계산 타일을 운반하는 아래 경로와 결과를 검토한 뒤 계산을 분기시키는 느린 위 경로를 구분한 연구 실행 개념 일러스트](avatar_control_hero.webp)
...
<img src="control_boundary_ko.svg" alt="빠른 규칙 실행은 계속 유지하고 실패나 탐색 정체만 느린 LLM 검토로 보내며, 제안은 상태·권한·과학 조건 검사를 통과한 뒤 실행하는 제안 구조">
