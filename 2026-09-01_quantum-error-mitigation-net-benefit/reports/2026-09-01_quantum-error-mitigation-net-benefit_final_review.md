...
<figure class="article-hero-figure">
  <img src="../artifacts/quantum_error_mitigation_hero-web.webp" alt="깨끗해지는 양자 측정 신호와 늘어나는 큐비트·회로 반복·측정 샷을 양팔저울에 놓은 개념 일러스트" width="1536" height="1024" loading="eager">
...
<figure class="figure-panel figure-panel-fit">
  <img src="../artifacts/mitigation_resource_ledger_ko.svg" alt="판독 반복부호와 적응형 ZNE가 쓰는 자원, 계산 결과, 실제 QPU와 수치실험의 경계를 비교하고 일곱 개 기록 항목을 보여주는 도표" width="1600" height="1060" loading="lazy">
...
[원문 경계를 바로잡은 5쪽 Daily Quantum Brief PDF 내려받기](../artifacts/daily_quantum_brief_2026-09-01.pdf)
