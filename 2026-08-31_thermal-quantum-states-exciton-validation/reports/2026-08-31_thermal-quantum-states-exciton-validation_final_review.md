...
<figure class="figure-panel figure-panel-fit">
  <img src="../artifacts/evidence_layers_ko.png" alt="Gibbs 상태 준비, 이차원 XY 확산, 유기 반도체 엑시톤, fluxonium-transmon 아키텍처, 기하학적 펄스 제어를 실행 위치에 따라 구분한 증거 지도" width="1800" height="1380" loading="lazy">
...
[검증된 4쪽 Daily Quantum Brief PDF 내려받기](../artifacts/daily_quantum_brief_2026-08-31.pdf)
