...
![Conceptual illustration combining a quantum processor, classical GPUs, a measurement ledger, continuous-variable potentials, and hybrid-computing boundaries](../artifacts/quantum_evidence_ledger_hero-web.webp)
...
The 5-page technical brief, whose layout has been verified, is available as a [PDF download](../artifacts/daily_quantum_brief_2026-09-04.pdf).
...
![Five-column resource ledger mapping six studies across observable and denominator, execution location, circuit and measurement, classical pre- and post-processing, and baseline and nonclaims](../artifacts/quantum_evidence_ledger_en.svg)
