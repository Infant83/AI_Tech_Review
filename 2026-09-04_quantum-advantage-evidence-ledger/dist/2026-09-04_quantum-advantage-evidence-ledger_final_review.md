...
![양자프로세서, 고전 GPU, 측정 장부, 연속변수 potential과 하이브리드 계산 경계를 한 장면에 배치한 개념 일러스트](quantum_evidence_ledger_hero-web.webp)
...
레이아웃을 검증한 5쪽 기술 브리프는 [PDF로 내려받을 수 있다](daily_quantum_brief_2026-09-04.pdf).
...
![관측량·분모, 실행 위치, 회로·측정, 고전 전후처리, 기준선·미입증의 다섯 칸을 여섯 연구에 대응시킨 자원 장부](quantum_evidence_ledger_ko.svg)
