...
![Concept illustration connecting coupled electron–nuclear motion, potential-energy surfaces, and grid-encoded quantum time evolution](../artifacts/vibronic_dynamics_quantum_simulation_hero.jpg)
...
![Exact mapping from the KDC Hamiltonian to qubit grids and a symmetric second-order Trotter step](../artifacts/vibronic_dynamics_algorithm_map.svg)
