...
![고전 CPU 계산 장치와 Ir·Pt OLED 인광체의 분자·오비탈 모형, 발광 소자를 연결한 생성 개념 일러스트](oti_iqcc_oled_hero_imagegen-web.webp)
...
![DFT 전처리에서 고전 iQCC 에뮬레이션과 OLED 여기상태 해석, 미래 QPU 기준선으로 이어지는 계산 경계](oti_iqcc_oled_boundary.svg)
...
![금속에서 리간드로 여기 성격이 이어지는 MLCT 개념과 리간드에 더 국소화된 LC 개념을 대비한 비특정 분자 일러스트](oti_iqcc_mlct_lc_imagegen-web.webp)
