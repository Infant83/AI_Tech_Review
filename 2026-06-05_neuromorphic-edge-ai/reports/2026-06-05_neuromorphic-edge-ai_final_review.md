...
<figure class="article-hero-figure">
  <img src="../artifacts/final_review/figures/imagegen/neuromorphic_physical_ai_hero-web.png" alt="물리적 AI 환경에서 센서 가까이 놓인 뉴로모픽 비전 모듈, 에이전트 모델 계층, 검증 대상 로봇 환경을 표현한 생성 일러스트">
